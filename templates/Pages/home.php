    ...
    try {
        ...
        if ($name === 'debug_kit') {
            $error = 'Try adding your current <b>top level domain</b> to the
                <a href="https://book.cakephp.org/debugkit/4/en/index.html#configuration"
                    target="_blank">DebugKit.safeTld
                </a>
            config and reload.';
            if (!in_array('sqlite', \PDO::getAvailableDrivers())) {
                $error .= '<br />You need to install the PHP extension '
                    . '<code>pdo_sqlite</code> so DebugKit can work properly.';
            }
        }
    }
            ...
            <div class="content">
                <div class="row">
                    <div class="column">
                        <div class="message default text-center">
                            <small>
                                Please be aware that this page will not be shown if you turn off debug mode
                                unless you replace templates/Pages/home.php with your own version.
                            </small>
                        </div>
                        <div
                            ...
                            <ul>
                                <li class="bullet problem">
                                    ...
                                    <a
                                        target="_blank"
                                        rel="noopener"
                                        href="https://book.cakephp.org/4/en/installation.html#url-rewriting"
                                    >
                    ...
                    <div class="column">
                        ...
                        <?php if (version_compare(PHP_VERSION, '7.4.0', '>=')) : ?>
                            <li class="bullet success">
                                Your version of PHP is 7.4.0 or higher (detected <?= PHP_VERSION ?>).
                            </li>
                        <?php else : ?>
                            <li class="bullet problem">
                                Your version of PHP is too low. You need PHP 7.4.0 or higher to use CakePHP (detected <?= PHP_VERSION ?>).
                            </li>
                        <?php endif; ?>
                ...
                <div class="row">
                    <div class="column links">
                        ...
                        <a target="_blank" rel="noopener" href="irc://irc.freenode.net/cakephp">
                            irc.freenode.net #cakephp
                        </a>
                        <a target="_blank" rel="noopener" href="https://slack-invite.cakephp.org/">Slack</a>
                        <a target="_blank" rel="noopener" href="https://github.com/cakephp/cakephp/issues">
                            CakePHP Issues
                        </a>
                ...
                <div class="row">
                    <div class="column links">
                        ...
                        <a target="_blank" rel="noopener" href="https://github.com/FriendsOfCake/awesome-cakephp">
                            CakePHP Awesome List
                        </a>
                ...
                <div class="row">
                    <div class="column links">
                        ...
                        <a target="_blank" rel="noopener" href="https://cakefoundation.org/">
