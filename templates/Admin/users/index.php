        ...
        <?php foreach ($users as $u): ?>
          ...
          <tr>
            ...
            <td>
              ...
              <?php else: ?>
                <span class="badge text-bg-warning text-dark"><i class="fa-regular fa-circle-question me-1"></i>未認証</span>
              <?php endif; ?>
            </td>
            ...
            <td class="text-end text-nowrap">
              <?= $this->Html->link('表示', ['prefix'=>false,'controller'=>'Users','action'=>'profile',$u->id], ['class'=>'btn btn-sm btn-outline-secondary']) ?>
